...
/** 三档的圆圈：待定是虚线空心圈，确定是实线空心圈，完成是实心打勾。 */
  ...
  return (
    <svg aria-hidden viewBox="0 0 16 16" className="size-4 shrink-0" fill="none">
      <circle
        ...
        fill={mark === "done" ? "currentColor" : "none"}
      />
      {mark === "done" && (
...
export function markItems(doc: Y.Doc, block: BlockView): MenuItem[] {
  return (["pending", "decided", "done"] as BlockMark[]).map((mark) => ({
